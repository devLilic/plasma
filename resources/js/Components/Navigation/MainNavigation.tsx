        ...
        <nav className="bg-white border-b border-gray-100">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    <div className='sm:flex justify-between h-16 py-2 hidden'>
                        <Menu open={showingNavigationDropdown} handler={setShowingNavigationDropdown}
                            ...
                            <MenuHandler>
                                ...
                                >
                                    ...
                                    <Typography className='normal-case mx-2'>{user.name}</Typography>
                                    <ChevronDownIcon
                                        strokeWidth={2.5}
                            ...
                            <MenuList className="p-1 hidden sm:block">
                                ...
                                <Link href={route('logout')} method='post' as='button'
                                      className="flex items-center gap-2 px-3 py-2 rounded w-full text-red-400 font-bold">
                                    <svg
                                        width="16"
                                        height="14"
                                        viewBox="0 0 16 14"
            ...
            <MobileNavigation showingNavigationDropdown={showingNavigationDropdown} user={user}/>
        </nav>
    );
};
